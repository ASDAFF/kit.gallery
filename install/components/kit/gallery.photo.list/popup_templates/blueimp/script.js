...
BX.ready(function(){
    ...
    function InitGallery(){
        BX.loadScript("/bitrix/components/kit/gallery.photo.list/popup_templates/blueimp/js/jquery.blueimp-gallery.min.js", function(){
        BX.loadCSS("/bitrix/components/kit/gallery.photo.list/popup_templates/blueimp/css/blueimp-gallery.min.css");
