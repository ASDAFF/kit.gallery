...
include ($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/kit.gallery/classes/general/kit_gallery.php");

if (class_exists('kit_gallery')) return;

Class kit_gallery extends CModule
{
    var $MODULE_ID = "kit.gallery";
    var $MODULE_VERSION;
	...
	function UnInstallFiles()
	{
		...
		if($_ENV["COMPUTERNAME"]!='BX')
		{
			...
			DeleteDirFilesEx("/bitrix/components/kit/gallery.album.list/");
			DeleteDirFilesEx("/bitrix/components/kit/gallery.photo.list/");
