...
$(document).ready(function () {
    ...
    $fine_uploader.fineUploader({
        request: {
            endpoint: '../admin/kit_gallery_ajax.php?action=edit_item&sessid=' + bxSession.sessid,
            params: {
                item_path: '',
    ...
    $fine_uploader.on('submit', function(event, id, namefileName) {
        var collection_id;
        if(kit_gallery_section.parent_collection && kit_gallery_section.parent_collection > 0){
