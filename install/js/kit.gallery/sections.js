...
var KitGallery = {
    ...
    'edit': function(id, mode){
        ...
        BX.ready(function(){
            ...
            var url = "/bitrix/admin/kit_gallery_ajax.php";
    ...
    'showEditDialog': function(item, save_mode){
        ...
        BX.ready(function(){
            ...
            var sort = item.SORT || "500",
                languages = kit_gallery_section.languages,
                inner_content = "",
                action_url = '/bitrix/admin/kit_gallery_ajax.php?action=edit_'+save_mode+'&lang='+kit_gallery_section.site_id+'&sessid='+bxSession.sessid
    ...
    'showDialog': function(params){
        ...
        BX.ready(function(){
            ...
            var Dialog = new BX.CAdminDialog({
                ...
                height: '168',
                width: '400',
                content_url: '/bitrix/admin/kit_gallery_ajax.php?action=edit_collection&lang='+kit_gallery_section.site_id+'&sessid='+bxSession.sessid,
                buttons: [btnSave, BX.CDialog.btnCancel]
            });
            Dialog.Show();
        });
    ...
    'getParentID': function(){
        ...
        if(!collection_id)
            collection_id = kit_gallery_section.parent_collection;
